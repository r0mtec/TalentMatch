...
- `must_score`;
- `nice_score`;
- грейд, локацию и гражданство кандидата из карточки кандидата, заполненной вручную или parser-service;
- закрытые требования с указанным весом требования;
- отсутствующие требования с указанным весом требования;
- `evidence_text`.

PDF comparison report содержит таблицу последних assessment по кандидатам одного request и фактические значения грейда, локации и гражданства кандидатов вместо статусов совпадения.
